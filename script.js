...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (fileInput) {
        fileInput.addEventListener('change', function (e) {
            if (this.files && this.files.length > 0) {
                ...
                // Validation for size (e.g., 5MB limit)
    ...
    // const formMessage = document.getElementById('form-message'); // Deprecated in favor of Toast
    ...
    if (uploadForm) {
        uploadForm.addEventListener('submit', function (e) {
            ...
            setTimeout(() => {
                ...
                // Show success toast
                showToast('Su informe ha sido enviado correctamente.', 'success');
    ...
    let instaPosts = [
        ...
        },
        {
            ...
            date: "Reciente",
            imageUrl: "insta-3.png", // Imagen corregida
